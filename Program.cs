                    ...
                    try
                    {
                        ...
                        for (int s = 0; s < m.screeningList.Count; s++)
                        {
                            ...
                            else
                            {
                                for (int n = 0; n < sList.Count; n++)
                                {
                                    if (sList[n].ScreeningNo == screeningOption)  // test if screening number is within available range
                                    {
                                        withinRange = true;
                                    }
                                    else
                        ...
                        if (!withinRange)  // reject if input is not within screening number range
                        {
                            Console.WriteLine("The screening number you have entered in not in our records. Please try again.");
                        }
                        else if (withinRange==true && validMovieScreening==false)  // reject if within range but is not a screening number for the chosen movie
                        {
